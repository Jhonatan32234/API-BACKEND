...
Calificacion.getAll = (nombre, result) => {
    let query = "select alumnos.idAlumno, alumnos.NombreAlumno ,alumnos.Apellidos, calificacion.Corte1 ,calificacion.Corte2,calificacion.Corte3 ,calificacion.Calificacion,calificacion.Reprobado from alumnos inner join calificacion on alumnos.idAlumno = calificacion.idCalificacion";
